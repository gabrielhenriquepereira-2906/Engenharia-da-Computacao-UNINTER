...
Este é meu repositório central de estudos, projetos e documentação técnica do meu bacharelado. Meu objetivo é manter um registro organizado da transição entre a teoria acadêmica e a implementação prática em software e hardware.

### Perfil Profissional
Como acadêmico de Engenharia, meu objetivo é desenvolver soluções inovadoras e criativas para os problemas da atualidade. Este repositório demonstra minha disciplina e constância com a **documentação de código**, organização de projetos e a aplicação prática de conceitos teóricos de engenharia em problemas reais de computação.
...
* **O Engenheiro de Computação e a Profissão** ![Status](https://img.shields.io/badge/Status-Concluído-brightgreen)
    ...
    - [x] [**Lab 05**](./Semestre-01/Engenharia-da-Computacao-e-a-Profissao/Sistemas-Embarcados-Arduino): Sistemas embarcados e automação (Arduino).
...
This is my central repository for academic studies, projects, and technical documentation. My goal is to maintain an organized record of the transition between academic theory and practical implementation in software and hardware.

### Professional Profile
As an Engineering student, I aim to develop innovative and creative solutions for today's challenges. This repository demonstrates my discipline and consistency in **code documentation**, project organization, and the practical application of engineering concepts to real-world computing problems.
...
* [**Programming Logic and Algorithms**](./Semestre-01/Logica-de-Programacao-e-Algoritmos) ![Status](https://img.shields.io/badge/Status-In%20Progress-blue)
    ...
    - **Modularization:** Function implementation and variable scope.
...
* **The Computer Engineer and the Profession** ![Status](https://img.shields.io/badge/Status-Completed-brightgreen)
    ...
    - [x] [**Lab 05**](./Semestre-01/Engenharia-da-Computacao-e-a-Profissao/Sistemas-Embarcados-Arduino): Embedded systems and automation (Arduino).
...
## Contato / Contact
* **Bacharelando em Engenharia de Computação** | UNINTER.
* **Languages:** Português (Nativo), English (Cambridge Certified).
* **Location:** Indaial, SC - Brasil.

---
**Gabriel Henrique Pereira** 

*Focus: Computer Engineering | Software Development | Robotics & AI*
