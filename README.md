...
* **O Engenheiro de Computação e a Profissão**
    ...
    - [ ] [**Lab 04**](./Semestre-01/Engenharia-da-Computacao-e-a-Profissao/Sistemas-Eletronicos): Simulação de circuitos e clock (Multisim Live).
...
* **The Computer Engineer and the Profession**
    ...
    - [ ] **Lab 03:** Android Mobile Development (MIT App Inventor).
    - [ ] **Lab 04:** Electronic circuit simulation and clock (Multisim Live).
